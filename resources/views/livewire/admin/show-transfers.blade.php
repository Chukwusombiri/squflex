<div class="relative bg-white rounded-xl mb-10">
    ...
    <div
        ...
        <h4 class="text-lg font-semibold ">Fund transfer records</h4>        
    </div>
    <x-admin-alert /> 
    {{-- search --}}
    <div class="my-10 w-full px-4 flex items-center">
        <div class="w-full relative border h-12 shadow p-4 rounded-full flex items-center">
            <input type="text" wire:model="search"
                ...
                placeholder="Filter by sender, receiver or amount">
                                    ...
                                    <div class="flex px-2 py-1">
                                        <div class="flex flex-col justify-center">
                                            <p
                                                ...
                                                ${{ number_format($transfer->amount) }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                     <p class="font-semibold mb-0 text-xs leading-tight   text-slate-700">
                                        ...
                                        <a href="{{ route('admin.user.show', [$transfer->sender_id]) }}" class="ml-3 futura-light text-sm underline">click to view</a>
                                        @endif
                                    </p>
                                </td>                                                             
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                     <p class="font-semibold mb-0 text-xs leading-tight   text-slate-700">
                                        ...
                                        <a href="{{ route('admin.user.show', [$transfer->receiver_id]) }}" class="ml-3 futura-light text-sm underline">click to view</a>
                                        @endif
                                    </p>
                                </td>
                                <td
                                    ...
                                    <span
                                        class="text-xs font-semibold leading-tight   text-slate-400">{{ date('M d, Y | H:i', strtotime($transfer->created_at)) }}</span>
                                </td>
                                ...
                                <td
                                    ...
                                    <span
                                        ...
                                        @if ($transfer->status==='transferred')
                                            <span class="futura-book text-emerald-400 bg-emerald-50 p-2 rounded-xl">approved</span>
                                        @elseif($transfer->status==='rejected')
                                            <span class="futura-book text-rose-400 bg-rose-50 p-2 rounded-xl">rejected</span>
                                        @else
                                            <span class="futura-book text-yellow-600 bg-yellow-50 p-2 rounded-xl">pending</span>
                                        @endif
                                    </span>
                                </td>
                                <td
                                        ...
                                        <x-slot name="content">
                                            ...
                                            @if (!$transfer->isApproved)
                                                <button
                                                    ...
                                                    wire:click="approve('{{ $transfer->id }}')">
                                                    <span class="mr-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
