<div class="relative bg-white rounded-xl mb-10">
  ...
  <div
      ...
      <a href="{{ route('admin.withdrawal.create') }}" class="futura-book rounded-full border border border-neutral-900 px-4 py-2 bg-neutral-900 text-gray-100 hover:text-gray-100">
          create
      </a>
  </div>
  <x-admin-alert /> 
                                  ...
                                  <x-dropdown align="right" width="48">
                                      ...
                                      <x-slot name="content">
                                          ...
                                          @if (!$withdrawal->isApproved)
                                              ...
                                              <button
                                                  class="flex item-center w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out"
                                                  wire:click='$emit("openModal","admin.edit-withdrawal",@json([$withdrawal->id]))'>
                                                  <span class="mr-2">
                                                      <svg xmlns="http://www.w3.org/2000/svg"
