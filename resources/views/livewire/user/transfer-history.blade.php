    ...
    <div class="flex-none w-full max-w-full px-3">
        <div
            ...
            <div
                ...
                <h6 class="text-xl futura-medium mb-6 md:mb-0">Funds Transfer History</h6>
                <x-link-two href="{{route('user.transfer.create')}}" class="rounded-xl tracking-wide">transfer funds</x-link-two>
            </div>
            <div class="my-10 w-full px-2 flex items-center">
                <div class="w-full relative border h-12 shadow p-4 rounded-full flex items-center">
                    <input type="text" wire:model="search"
                        ...
                        placeholder="Filter by beneficiary, or amount">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <p
                                                ...
                                                {{ $transfer->sender_id===auth()->user()->id ? 'YOU' : $transfer->sender }}</p>
                                        </td>
                                        <td
                                            class="p-2 text-sm leading-normal text-left align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <p
                                                class="mb-0 text-sm font-semibold leading-tight">
                                                {{ $transfer->receiver_id===auth()->user()->id ? 'YOU' : $transfer->receiver }}</p>
                                        </td>
                                        <td
                                            class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <span
                                                class="text-sm font-semibold leading-tight text-neutral-900">{{ date('M d, Y | H:i', strtotime($transfer->created_at)) }}</span>
                                        </td>
                                        ...
                                        <td
                                            ...
                                            <span
                                                ...
                                                @if ($transfer->status=='transferred')
                                                    <span class="futura-book text-emerald-400 bg-emerald-50 p-2 rounded-xl">transfered</span>
                                                @elseif($transfer->status=='rejected')
                                                    <span class="futura-book text-rose-600 bg-rose-50 p-2 rounded-xl">pending</span>
                                                @else
